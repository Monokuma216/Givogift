...
const tabs = ref( [ { label: 'Желаемое', icon: 'i-lucide-heart' }, { label: 'События', icon: 'i-lucide-calendar' }, { label: 'Друзья', icon: 'i-lucide-users' }, { label: 'Заметки', icon: 'i-lucide-notebook' }, { label: 'Профиль', icon: 'i-lucide-user' }, ] );
...
<template>
  <div class="w-full p-4 flex items-center bg-(--ui-bg-elevated)">
    <div class="flex md:hidden mr-10">
      <UButton
        variant="ghost"
        icon="i-lucide-menu"
      />
